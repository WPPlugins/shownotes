...
function shownotes_version() {
  ...
  if(isset($options['version'])) {
    ...
    if($version != $lastversion) {
      ...
      if(versionInt($lastversion) < versionInt('0.5.6')) {
        print '<p><b>0.5.6: </b>fix &quot;PHP Error: The /e modifier is deprecated&quot;</p>';
      }
...
function shownotes_info() {
  ...
  print '<p>This is <strong>Version 0.5.6</strong> of the <strong> Shownotes</strong>.<br>
