...
function shownotesshortcode_add_styles() {
  ...
  if (!is_feed()) {
    ...
    wp_enqueue_style('shownotesstyle', plugins_url('static/' . $css_styles[$shownotes_options['css_id']] . '.css', __FILE__), array(), '0.5.6');
  }
}
...
function shownotesshortcode_add_admin_scripts() {
  if (!is_feed()) {
    wp_enqueue_script('majax', plugins_url('static/majaX/majax.js', __FILE__), array(), '0.5.6', false);
    wp_enqueue_script('importPad', plugins_url('static/shownotes_admin.js', __FILE__), array(), '0.5.6', false);
    wp_enqueue_script('tinyosf', plugins_url('static/tinyOSF/tinyosf.js', __FILE__), array(), '0.5.6', false);
    wp_enqueue_script('tinyosf_exportmodules', plugins_url('static/tinyOSF/tinyosf_exportmodules.js', __FILE__), array(), '0.5.6', false);
  }
}

function shownotesshortcode_add_scripts() {
  if (!is_feed()) {
    wp_enqueue_script('importPad', plugins_url('static/shownotes.js', __FILE__), array(), '0.5.6', false);
  }
}
